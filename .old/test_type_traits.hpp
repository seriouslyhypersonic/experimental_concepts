...
using expectA =
select_t<traits::condition<true, TypeA>, traits::condition<true, TypeB>, traits::condition<false, TypeC>>;

using expectB =
traits::select_t<traits::condition<false, TypeA>, traits::condition<true, TypeB>, traits::condition<true, TypeC>>;

using expectC =
select_t<condition<false, TypeA>, condition<false, TypeB>, condition<true, TypeC>>;

using expectD =
select_t<condition<false, TypeA>, condition<false, TypeB>, condition<false, TypeC>, TypeD>;
...
static_assert(std::is_same_v<common_reference_t<const A&, const B&>, const B&>);
...
static_assert(
std::is_same_v<common_reference_t<int const volatile&&, int volatile&&>, int const volatile&&>);
static_assert(
std::is_same_v<common_reference_t<int&&, int const&, int volatile&>, int const volatile&>);
...
{
template<>
struct common_type<test_traits::X, Y>
{
    using type = Z;
};
